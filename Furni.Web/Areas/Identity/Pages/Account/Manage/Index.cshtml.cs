...
namespace Furni.Web.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetTwoFactorAsync()
        {
            var user = await _userManager.GetUserAsync(User);
            if (user == null)
            {
		...
		public async Task<IActionResult> OnPostTwoFactorAuthenticationAsync()
		{
			var user = await _userManager.GetUserAsync(User);
			if (user == null)
			{
